  ...
  if (validCommands.includes(cmd)) {
    try {
      ...
      const formatCreationDate = (timestamp) => {
        ...
        return date.toLocaleString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit', timeZoneName: 'short' });
      };
      ...
      if (isGroup) {
        ...
        if (!groupLink.includes('chat.whatsapp.com')) {
          let responseMessage = 'Please provide a valid WhatsApp group invite link.';
          await sock.sendMessage(m.from, {
            text: " ",
            contextInfo: {
            isForwarded: true,
        ...
        try {
          ...
          let responseMessage = 'Error fetching group info. Make sure:\n1. The link is valid\n2. You have permission to view this group\n3. The group exists';
          await sock.sendMessage(m.from, {
            text: " ",
            contextInfo: {
            isForwarded: true,
        ...
        let responseMessage = 'Please use this command in a group or provide a group invite link.\n\nExample: .gcinfo https://chat.whatsapp.com/XXXXXXXXXXXX';
        await sock.sendMessage(m.from, {
          text: " ",
          contextInfo: {
          isForwarded: true,
      ...
      let responseMessage = 'An error occurred while fetching group information.';
      await sock.sendMessage(m.from, {
        text: " ",
        contextInfo: {
        isForwarded: true,
